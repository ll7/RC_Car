...
class image_feature:
    ...
    def __init__(self):
        ...
        self.record_sub = rospy.Subscriber("/record", Int16, self.record_cb)
    ...
    def record_cb(self, data):
        ...
        if record and not record_old and VERBOSE:
            print 'Started recording'
            record_start_time = time.time()
            
        if not record and record_old:
            if VERBOSE:
            ...
            try:    
                ...
                if VERBOSE:
                    print 'Recording saved. Saved ', frame, ' frames.'
                    print 'The recording has the name: ', file_name, '.npz'
                    print 'The duration of the record was: ', time.time()-record_start_time, ' seconds.'
            except IOError as e:
                print(e)
...
def main(args):
    ...
    ic = image_feature()
    rospy.init_node('image_listener005', anonymous=True)
    try:
        rospy.spin()
